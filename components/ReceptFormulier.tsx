...
type BestaandRecept = { id: string; naam: string; ingredienten: string[] }

/** Gelijkenis tussen twee receptnamen (0–1). */
function naamGelijkenis(a: string, b: string): number {
...
function ingredientenOverlap(lijstA: string[], lijstB: string[]): number {
...
const DREMPELWAARDE = 0.72 // boven deze score → waarschuwing
